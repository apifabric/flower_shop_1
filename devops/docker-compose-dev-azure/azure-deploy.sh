...
resourcename="flowershop1"  # lower case, only
resourcegroup="flowershop1_rg"
...
# git clone https://github.com/apilogicserver/flowershop1.git
# cd flowershop1
...
az group create --name flowershop1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group flowershop1_rg --sku S1 --is-linux
az container create --resource-group flowershop1_rg --name flowershop1 --image apilogicserver/flowershop1:latest --dns-name-label flowershop1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//flowershop1.westus.azurecontainer.io:5656'
